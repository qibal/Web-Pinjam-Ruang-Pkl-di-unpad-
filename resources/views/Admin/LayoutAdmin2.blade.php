...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark  sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item ">
                <a class="nav-link  {{ Route::is('/admin/home') ? 'active' : '' }}" href="{{ url('/admin/home') }}">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('/admin/TableLantai') }}">Table Lantai</a>
                        <a class="collapse-item" href="{{ url('/admin/TableRuangan') }}">Table Ruangan</a>
                    </div>
                </div>
            </li>
            ...
            {{-- prosedur pinjam --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/ProsedurPinjam') }}">
                    <i class="fa-solid fa-file-lines"></i>
                    <span>Prosedur Pinjam</span></a>
            </li>
            {{-- prosedur pinjam --}}
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/DataPeminjam') }}">
                    <i class="fa-solid fa-user-check"></i>
                    <span>Data Peminjam</span></a>
            </li>
            {{-- prosedur pinjam --}}
            <li class="nav-item">
                <a class="nav-link " href="{{ url('/admin/daftarUser') }}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        {{-- <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown notif" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('icon/person-circle.svg') }}">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{ route('admin.profileAdmin') }}">
